...
export const apiClient = {
  ...
  users: {
    ...
    async getProfile(): Promise<any> {
      return await request<any>('/api/users/me');
    },

    /**
     * Get current user statistics
     * @returns User statistics (task counts, completion rates, etc.)
     */
    async getStats(): Promise<any> {
      return await request<any>('/api/users/me/stats');
    },
    ...
    async updateSettings(settings: any): Promise<any> {
      return await request<any>('/api/users/me/settings', {
        method: 'PATCH',
  ...
  notifications: {
    ...
    async markAsRead(id: number): Promise<any> {
      return await request<any>(`/api/notifications/${id}/read`, {
        method: 'PATCH',
      });
    },
    ...
    async markAllAsRead(): Promise<any> {
      return await request<any>('/api/notifications/read-all', {
        method: 'PATCH',
      });
    },
